...
func (fu *FileUpdate) SetRomID(id int) *FileUpdate {
	fu.mutation.SetRomID(id)
	return fu
}

// SetNillableRomID sets the "rom" edge to the Rom entity by ID if the given value is not nil.
func (fu *FileUpdate) SetNillableRomID(id *int) *FileUpdate {
	if id != nil {
		fu = fu.SetRomID(*id)
	}
	return fu
...
func (fu *FileUpdate) SetRom(r *Rom) *FileUpdate {
	return fu.SetRomID(r.ID)
}
...
func (fu *FileUpdate) ClearRom() *FileUpdate {
	fu.mutation.ClearRom()
	return fu
}
...
func (fu *FileUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := fu.mutation.RomIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   file.RomTable,
...
// SetRomID sets the "rom" edge to the Rom entity by ID.
func (fuo *FileUpdateOne) SetRomID(id int) *FileUpdateOne {
	fuo.mutation.SetRomID(id)
	return fuo
}

// SetNillableRomID sets the "rom" edge to the Rom entity by ID if the given value is not nil.
func (fuo *FileUpdateOne) SetNillableRomID(id *int) *FileUpdateOne {
	if id != nil {
		fuo = fuo.SetRomID(*id)
	}
	return fuo
...
// SetRom sets the "rom" edge to the Rom entity.
func (fuo *FileUpdateOne) SetRom(r *Rom) *FileUpdateOne {
	return fuo.SetRomID(r.ID)
}
...
// ClearRom clears the "rom" edge to the Rom entity.
func (fuo *FileUpdateOne) ClearRom() *FileUpdateOne {
	fuo.mutation.ClearRom()
	return fuo
}
...
func (fuo *FileUpdateOne) sqlSave(ctx context.Context) (_node *File, err error) {
	...
	if nodes := fuo.mutation.RomIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   file.RomTable,
